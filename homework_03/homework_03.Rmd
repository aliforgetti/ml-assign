...
As we increase the value of k, the model tends moves towards lower variance. 
...
```
This is the best tuning parameter value as it one standard deviation of the lowest test error rate. 
